...
ALTER TABLE ONLY bill
    ADD CONSTRAINT fk_billid_userid FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY orderlines
    ADD CONSTRAINT fk_orderlinesid_itemid FOREIGN KEY (item_id) REFERENCES item(item_id) ON DELETE CASCADE;
    ALTER TABLE ONLY cart
	ADD CONSTRAINT fk_cart_itemid FOREIGN KEY (item_id) REFERENCES items(item_id) ON DELETE CASCADE;
    ALTER TABLE ONLY cart
	 ADD CONSTRAINT fk_cart_userid FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE;	
...
--2. Items
insert into item (item_id, item_name, theme, price, quantity, brand) values('001', 'Áo hoodie ', 'Áo', 350000,5,'H&M');
insert into item (item_id, item_name, theme, price, quantity, brand) values ('002', 'Áo len lông thỏ ', 'Áo', 200000, 10, 'Mango' );
insert into item (item_id, item_name, theme, price, quantity, brand) values ('003', 'Áo len có cổ ', 'Áo', 540000, 7, 'Mango' );  
insert into item (item_id, item_name, theme, price, quantity, brand) values ('004', 'Quần Jockers', 'Quần ', 600000, 30, 'uniqlo');
insert into item (item_id, item_name, theme, price, quantity, brand) values ('005', 'Áo phông', 'Áo', 300000, 18, 'Zara');
insert into item (item_id, item_name, theme, price, quantity, brand) values ('006', 'Chân váy chữ A', 'Váy', 250000, 19, 'Zara');
insert into item (item_id, item_name, theme, price, quantity, brand) values ('007', 'Áo dạ', 'Áo', 500000, 9, 'Emily');
insert into item (item_id, item_name, theme, price, quantity, brand) values ('008', 'Áo cadigan', 'Áo', 230000, 5, 'Emily');
insert into item (item_id, item_name, theme, price, quantity, brand) values ('009', 'Áo khoác gió', 'Áo', 380000, 9, 'Emily');
insert into item (item_id, item_name, theme, price, quantity, brand) values ('010', 'Áo giữ nhiệt', 'Áo', 360000, 9, 'uniqlo');
insert into item (item_id, item_name, theme, price, quantity, brand) values ('011', 'Áo gile', 'Áo', 250000, 3, 'H&M');
insert into item (item_id, item_name, theme, price, quantity, brand) values ('012', 'Quần Baggy ','Quần', 450000, 30, 'uniqlo');
insert into item (item_id, item_name, theme, price, quantity, brand) values ('013', 'Khăn len','Khăn', 250000,25,'Zara');
-- Coupon
...
--Bill
insert into bill(bill_id, user_id, coupon_id, bill_date) values ('13001', 1, '23002','2020-4-12');
insert into bill(bill_id, user_id, coupon_id, bill_date) values ('13002', 4, '23001','2020-5-22');
insert into bill(bill_id, user_id, coupon_id, bill_date) values ('13003', 3, '23005','2020-12-12');
insert into bill(bill_id, user_id, coupon_id, bill_date) values ('13004', 3, '23001','2020-8-12');
insert into bill(bill_id, user_id, coupon_id, bill_date) values ('13005', 5, '23002','2020-4-12');
insert into bill(bill_id, user_id, coupon_id, bill_date) values ('13006', 1, '23001','2020-11-12');
insert into bill(bill_id, user_id, coupon_id, bill_date) values ('13007', 1, '23004','2020-9-12');
insert into bill(bill_id, user_id, coupon_id, bill_date) values ('13008', 2, '23002','2020-12-24');
insert into bill(bill_id, user_id, coupon_id, bill_date) values ('13009', 3, '23001','2020-10-30');
insert into bill(bill_id, user_id, coupon_id, bill_date) values ('13010', 4, '23001','2020-6-1');
insert into bill(bill_id, user_id, coupon_id, bill_date) values ('13011', 5, '23003','2020-12-23');
...
insert into orderlines(bill_id,item_id,amount) values('13002', '003', 1);
insert into orderlines(bill_id,item_id,amount) values( '13002', '004', 1);

insert into orderlines(bill_id,item_id,amount) values('13003', '011', 1);
insert into orderlines(bill_id,item_id,amount) values('13003', '003', 1);
insert into orderlines(bill_id,item_id,amount) values('13003', '002', 1);
...
$$
begin
  select sum(price*amount) into total from item,orderlines where item.item_id = orderlines.item_id and orderlines.bill_id = bill__id ;
end;
$$  
stable
security definer
